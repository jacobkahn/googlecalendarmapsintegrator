...
var map;
var geocoder;
var jacob_address="University of Pennsylvania, Philadelphia, PA 19104, United States" 
var start_point = new google.maps.LatLng(40,75);
//my_rank: ABCDEF, the order of the events
//my_address: A string
function placeMarker(singleEvent)
{
  //eventList is a list of arrayLists with order, name, location, starting and ending time
